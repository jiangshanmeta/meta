...
var numSubarraysWithSum = function(A, S) {
    if(S === 0){
        ...
        for(let i=0;i<oneIndexs.length-S+1;i++){
            let leftZeroCount = i===0?oneIndexs[0]:oneIndexs[i]-oneIndexs[i-1]-1;
            let rightIndex = i+S-1;
            let rightZeroCount = rightIndex === oneIndexs.length-1?A.length-oneIndexs[rightIndex]-1:oneIndexs[rightIndex+1]-oneIndexs[rightIndex]-1;
